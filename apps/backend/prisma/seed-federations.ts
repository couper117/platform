...
const SPORTS = [
  { slug: 'football', name: 'Football', icon: '⚽', category: 'FIELD', type: 'TEAM', sortOrder: 1 },
  { slug: 'basketball', name: 'Basketball', icon: '🏀', category: 'COURT', type: 'TEAM', sortOrder: 2 },
  { slug: 'volleyball', name: 'Volleyball', icon: '🏐', category: 'COURT', type: 'TEAM', sortOrder: 3 },
  { slug: 'cycling', name: 'Cycling', icon: '🚴', category: 'OTHER', type: 'RACING', sortOrder: 4 },
  { slug: 'cricket', name: 'Cricket', icon: '🏏', category: 'FIELD', type: 'TEAM', sortOrder: 5 },
  { slug: 'rugby', name: 'Rugby', icon: '🏉', category: 'FIELD', type: 'TEAM', sortOrder: 6 },
  { slug: 'handball', name: 'Handball', icon: '🤾', category: 'COURT', type: 'TEAM', sortOrder: 7 },
  { slug: 'athletics', name: 'Athletics', icon: '🏃', category: 'TRACK', type: 'RACING', sortOrder: 8 },
  { slug: 'swimming', name: 'Swimming', icon: '🏊', category: 'WATER', type: 'RACING', sortOrder: 9 },
  { slug: 'tennis', name: 'Tennis', icon: '🎾', category: 'RACKET', type: 'RACKET', sortOrder: 10 },
  { slug: 'table-tennis', name: 'Table Tennis', icon: '🏓', category: 'RACKET', type: 'RACKET', sortOrder: 11 },
  { slug: 'badminton', name: 'Badminton', icon: '🏸', category: 'RACKET', type: 'RACKET', sortOrder: 12 },
  { slug: 'judo', name: 'Judo', icon: '🥋', category: 'COMBAT', type: 'COMBAT', sortOrder: 13 },
  { slug: 'karate', name: 'Karate', icon: '🥋', category: 'COMBAT', type: 'COMBAT', sortOrder: 14 },
  { slug: 'taekwondo', name: 'Taekwondo', icon: '🥋', category: 'COMBAT', type: 'COMBAT', sortOrder: 15 },
  { slug: 'boxing', name: 'Boxing', icon: '🥊', category: 'COMBAT', type: 'COMBAT', sortOrder: 16 },
  { slug: 'wrestling', name: 'Wrestling', icon: '🤼', category: 'COMBAT', type: 'COMBAT', sortOrder: 17 },
  { slug: 'kickboxing', name: 'Kickboxing', icon: '🥊', category: 'COMBAT', type: 'COMBAT', sortOrder: 18 },
  { slug: 'netball', name: 'Netball', icon: '🏐', category: 'COURT', type: 'TEAM', sortOrder: 19 },
  { slug: 'chess', name: 'Chess', icon: '♟️', category: 'OTHER', type: 'RACKET', sortOrder: 20 },
];
...
async function main() {
  ...
  for (const s of SPORTS) {
    ...
    const row = await prisma.sport.upsert({
      where: { name: s.name },
      update: { type: s.type }, // (re)classify by type; leave other curated fields untouched
      create: { name: s.name, slug: s.slug, icon: s.icon, category: s.category, type: s.type, sortOrder: s.sortOrder, active: true },
    });
