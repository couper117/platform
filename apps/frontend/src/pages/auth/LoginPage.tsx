          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                <label className="text-[10px] uppercase font-bold tracking-widest text-white/40 ml-1">{t('authx.email_or_username')}</label>
                <input
                  {...register('username')}
                ...
                />
                {errors.username && <p className="text-[10px] font-bold text-red uppercase tracking-widest ml-1">{t(errors.username.message)}</p>}
              </div>
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  placeholder="••••••••"
                />
                {errors.password && <p className="text-[10px] font-bold text-red uppercase tracking-widest ml-1">{t(errors.password.message)}</p>}
              </div>
            </div>
