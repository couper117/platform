...
export const ADMIN_PAGES = [
  ...
  { path: '/admin/teams', label: 'Teams', roles: ['SUPERADMIN', 'FEDERATION_ADMIN', 'LEAGUE_ADMIN'] },
  { path: '/admin/players', label: 'Players', roles: ['SUPERADMIN', 'FEDERATION_ADMIN', 'LEAGUE_ADMIN'] },
  { path: '/admin/documents', label: 'Documents', roles: ['SUPERADMIN', 'FEDERATION_ADMIN'] },
  { path: '/admin/news', label: 'News', roles: ['SUPERADMIN', 'FEDERATION_ADMIN', 'AMASHURI_ADMIN', 'LEAGUE_ADMIN'] },
  { path: '/admin/ads', label: 'Ads', roles: ['SUPERADMIN'] },
  { path: '/admin/visitors', label: 'Visitors', roles: ['SUPERADMIN', 'FEDERATION_ADMIN', 'AMASHURI_ADMIN', 'LEAGUE_ADMIN'] },
  { path: '/admin/akc3', label: 'Amashuri Games', roles: ['SUPERADMIN', 'AMASHURI_ADMIN'] },
  { path: '/admin/championships', label: 'Championships', roles: ['SUPERADMIN', 'AMASHURI_ADMIN', 'FEDERATION_ADMIN'] },
  { path: '/admin/settings', label: 'Settings', roles: ['SUPERADMIN', 'FEDERATION_ADMIN', 'AMASHURI_ADMIN', 'LEAGUE_ADMIN'] },
];
