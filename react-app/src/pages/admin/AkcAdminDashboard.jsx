    ...
    <div className="space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
        <div className="space-y-2">
          <h1 className="text-4xl font-display uppercase tracking-tighter">{t('admin.akc.title')} <span className="text-red">{t('admin.akc.title_accent')}</span></h1>
                ...
                <tbody className="divide-y divide-surface-3 dark:divide-white/5">
                  {schoolsLoading ? (
                    ...
                    <tr key={school.id} className="hover:bg-surface-2 dark:hover:bg-white/5 transition-colors">
                      ...
                      <td className="p-5">
                        <button className="text-[10px] font-bold text-red hover:underline uppercase">{t('admin.akc.manage')}</button>
                      </td>
                    </tr>
                  ))}
                </tbody>
